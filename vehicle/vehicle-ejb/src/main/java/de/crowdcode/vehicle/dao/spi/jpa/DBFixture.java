...
public class DBFixture
{
	...
	public void createDefaultDataInDatabase()
	{
		...
		this.createManufacturer("Buggati").addVehicle().setModelName("Veyron").setNettoPrice(1200000.00)
				.addEngine(EngineType.PETROL).setConstructionDate(new Date()).addVehicle()
				.setModelName("Veyron Diesel").setNettoPrice(999000.00).setConstructionDate(new Date())
				.addEngine(EngineType.DIESEL).createManufacturer("VW").addVehicle().setModelName("Trabbi")
				.setConstructionDate(new Date()).addEngine(EngineType.PETROL).createManufacturer("AUDI").addVehicle()
				.setModelName("A4").addEngine(EngineType.DIESEL).setConstructionDate(new Date()).persistAll();
	}
